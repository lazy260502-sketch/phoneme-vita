...
#ifdef VITA_CP_DEBUG
  /* Per-entry dump floods stderr (thousands of lines per class link) -
   * enable only for diagnosis. */
  fprintf(stderr, "variable_oops_do: this=%p len=%d base=%p tags=%p\n",
          (void*)this, (int)_length, (void*)base, (void*)tags);
#endif
...
#ifdef VITA_CP_DEBUG
      fprintf(stderr, "  var_oops_do i=%d tag=%d base=%p *base=%p\n",
              i, (int)tag, (void*)base, (void*)*base);
#endif
