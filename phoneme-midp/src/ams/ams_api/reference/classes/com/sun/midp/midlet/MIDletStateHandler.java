...
public class MIDletStateHandler {
    ...
    private void createAndRegisterMIDlet(int externalAppId, String classname)
        ...
        System.out.println("[MIDLET] creating " + classname);
        try {
            listener.midletPreStart(getMIDletSuite(), classname);
            register(createMIDlet(externalAppId, classname));
            System.out.println("[MIDLET] created+registered OK: " + classname);
        } catch (ClassNotFoundException e) {
            System.out.println("[MIDLET] FAILED(CNFE): " + classname);
            e.printStackTrace();
            System.out.flush();
            throw e;
        } catch (InstantiationException e) {
            System.out.println("[MIDLET] FAILED(IE): " + classname);
            e.printStackTrace();
            System.out.flush();
            throw e;
        } catch (IllegalAccessException e) {
            System.out.println("[MIDLET] FAILED(IAE): " + classname);
            e.printStackTrace();
            System.out.flush();
            throw e;
        } catch (RuntimeException e) {
            System.out.println("[MIDLET] FAILED(RE): " + classname);
            e.printStackTrace();
            System.out.flush();
            throw e;
        } catch (Error e) {
            System.out.println("[MIDLET] FAILED(Error): " + classname);
            e.printStackTrace();
            System.out.flush();
            throw e;
        }
    ...
    public void startSuite(MIDletSuiteExceptionListener exceptionHandler,
        ...
        System.out.println("[MIDLET] startSuite: " + classname);
        createAndRegisterMIDlet(externalAppId, classname);
