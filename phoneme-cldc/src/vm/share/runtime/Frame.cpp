...
void JavaFrame::gc_prologue(void do_oop(OopDesc**)) {
...
#endif
  {
    ...
    jint    flags      = (int)(address_word)frame_bcp - (int)(address_word)actual_bcp;
    GUARANTEE(actual_bci >= Method::base_offset(), "Sanity check");
    GUARANTEE((juint)(address_word)actual_bci < rm->object_size(), 
...
void JavaFrame::gc_epilogue(void) {
...
#endif
  {
    ...
    address frame_bcp  = (address)((int)(address_word)actual_bcp + flags);
...
void Frame::init(Thread *thread, address guessed_fp) {
  ...
  guessed_fp = (address) (((jint)(address_word)guessed_fp) & (~0x03));
  limit      = (address) (((jint)(address_word)limit)      & (~0x03));
  start      = guessed_fp;
