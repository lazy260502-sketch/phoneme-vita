...
#if defined(VITA) || defined(__PSP2__)
#define USE_VITA_SOCKETS 1
...
#if USE_VITA_SOCKETS
// Vita newlib provides a BSD-like socket API via SceNet
#include <unistd.h>
#include <sys/types.h>
#include <sys/time.h>
#include <errno.h>
...
#if defined(USE_UNISTD_SOCKETS) || defined(USE_VITA_SOCKETS)
