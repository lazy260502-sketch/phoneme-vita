...
#if defined(VITA)
  {
    /* v01.85: name the method being verified - narrows the loop to a
     * single method's code/stackmaps. v01.86: pass the Symbol length
     * - symbols are not NUL-terminated. */
    Symbol::Raw n = method->name();
    vita_site_verifier_method(n().base_address(), n().length());
  }
#endif
...
#if defined(VITA)
  vita_site_mark(); /* v01.85: phases done, iteration begins */
#endif
