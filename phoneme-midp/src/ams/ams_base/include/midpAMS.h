...
/**
 * Returns the application directory previously set with
 * midpSetAppDir, or NULL if none was set.
 *
 * @return home directory of MIDP or NULL
 */
const char* midpGetAppDir(void);
